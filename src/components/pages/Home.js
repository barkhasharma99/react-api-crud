    ...
    <Grid item md={6} xs={12}>
     ...
     <form noValidate>
      <Grid container spacing={2}>
       ...
       <Grid item xs={12}>
        <TextField autoComplete="Lname" name="Lname" variant="outlined" required fullWidth id="Lname" label="Last Name" onChange={e => onTextFieldChange(e)}
        />
       </Grid>
       <Grid item xs={12}>
        <TextField autoComplete="image" type='file'  name="image" variant="outlined" required fullWidth id="image"  onChange={e => onTextFieldChange(e)}
        />
       </Grid>
       <Grid item xs={12}>
